...
# will not give a singular matrix. Thus reporting
# mean error and standard error.
# trainsize = 20,000 and testsize = 10,000.
...
# Part 2c and 2d are merged to incorporate results in single file.
